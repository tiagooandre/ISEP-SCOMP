...
int main() {
    ...
    shm_unlink("/ex02"); //Removes the memory area from the file system

    fd = shm_open("/ex02", O_CREAT | O_EXCL | O_RDWR, S_IRUSR | S_IWUSR); //Creates and opens a shared memory area
